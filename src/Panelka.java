 ...
 */
public class Panelka extends JFrame implements Serializable {
    ...
    private void onSave() {
        try {
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("Sheba.ser"));
    ...
    private void onLoad() {
        try {
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("Sheba.ser"));
